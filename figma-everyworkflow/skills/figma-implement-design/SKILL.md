...
- Use this skill when the deliverable is **code in the user's repository** (Figma → code direction).
- If the user wants to **generate a new Figma design** from a description, HTML file, or wireframe (code/text → Figma direction), switch to [figma-generate-ui](../figma-generate-ui/SKILL.md). That skill handles the full AI generation workflow with design system discovery.
- If the user asks to create/edit/delete nodes inside Figma itself without a higher-level design goal, switch to [figma-use](../figma-use/SKILL.md).
- If the user asks to build or update a full-page screen in Figma from existing code (not from scratch), switch to [figma-generate-design](../figma-generate-design/SKILL.md).
...
|---|---|---|
| [figma-generate-ui](../figma-generate-ui/SKILL.md) | text/HTML/wireframe → Figma | Generate a new Figma design from a description, HTML file, or wireframe |
| [figma-generate-design](../figma-generate-design/SKILL.md) | code → Figma | Update an existing Figma screen to match source code changes |
| [figma-use](../figma-use/SKILL.md) | any → Figma | Low-level canvas writes: nodes, variables, styles |
| [figma-code-connect-components](../figma-code-connect-components/SKILL.md) | Figma ↔ code | Map Figma components to code implementations |
| [figma-create-design-system-rules](../figma-create-design-system-rules/SKILL.md) | Figma → rules | Generate project-specific design system rules |
